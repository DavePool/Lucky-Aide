...
public class RG_borrar_producto extends javax.swing.JFrame {
conexionBD abd = new conexionBD();
    public RG_borrar_producto() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Borrar Producto");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, abd.eliminarRegistro(Integer.parseInt(jt1.getText()),"producto"));
        jt1.setText("");
