...
public class RG_editar_producto extends javax.swing.JFrame {
conexionBD abd = new conexionBD();
    public RG_editar_producto() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 150, 140, -1));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 170, 170, 20));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 300, 120, 40));
        ...
        jPanel1.add(jt3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 200, 140, -1));
        jPanel1.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 220, 170, 20));
        ...
        jPanel1.add(jt4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 260, 140, -1));
        jPanel1.add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 280, 170, 20));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, abd.cambiarProducto(jt2.getText(), Float.parseFloat(jt3.getText()), Integer.parseInt(jt4.getText()), Integer.parseInt(jt1.getText())));
        jt1.setText("");
        jt2.setText("");
        jt3.setText("");
        jt4.setText("");
