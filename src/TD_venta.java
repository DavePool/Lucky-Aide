...
public class TD_venta extends javax.swing.JFrame {
    ...
    public String[] getColumnas(){
        String columna[] = new String[]{"Id","Id venta","Fecha de la venta","Total venta","Vendedor"};
        return columna;
    }
    
    public void setFilas(){
        try {
            ResultSet rst = abd.llenarTablaRealiza();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 140, -1));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 120, 170, 20));
        ...
        jPanel1.add(jt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 140, -1));
        jPanel1.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 80, 170, 20));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 210, 120, 40));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 50, 410, 150));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 690, 260));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, abd.agregarVende(Integer.parseInt(jt1.getText()), Integer.parseInt(jt2.getText())));
        jt1.setText("");
        jt2.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(idA>0){
            JOptionPane.showMessageDialog(null, abd.eliminarRegistro(idA,"realiza"));
        }else{
