...
public class RG_editar_proveedor extends javax.swing.JFrame {
    conexionBD abd = new conexionBD();
    
    public RG_editar_proveedor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Editar Provedor");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, abd.cambiarProveedor(jt2.getText(), jt3.getText(), jt4.getText(), jt5.getText(), jt6.getText(), jt7.getText(), Integer.parseInt(jt8.getText()), Integer.parseInt(jt1.getText())));
        jt1.setText("");
        jt2.setText("");
        jt3.setText("");
        jt4.setText("");
