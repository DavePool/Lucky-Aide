...
public class RG_registrar_cliente extends javax.swing.JFrame {
    conexionBD abd = new conexionBD();
    public RG_registrar_cliente() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, abd.agregarCliente(jt2.getText(), jt3.getText(), jt4.getText(), jt5.getText(), jt6.getText(), jt7.getText(), Integer.parseInt(jt8.getText())));
        jt2.setText("");
        jt3.setText("");
        jt4.setText("");
        jt5.setText("");
