...
public class RG_borrar_Empleado extends javax.swing.JFrame {
conexionBD abd = new conexionBD();
    public RG_borrar_Empleado() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Borrar Empleado");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, abd.eliminarRegistro(Integer.parseInt(jt1.getText()),"vendedor"));
        jt1.setText("");
