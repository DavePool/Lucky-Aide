...
public class TD_proveer extends javax.swing.JFrame {
    conexionBD abd = new conexionBD();
    DefaultTableModel tablaProvee;
    int idA;
    
    public TD_proveer() {
        tablaProvee= new DefaultTableModel(null, getColumnas());
        initComponents();
        this.setLocationRelativeTo(null);  
    }
    
    public String[] getColumnas(){
        String columna[] = new String[]{"Id", "Proveedor","Producto", "Fecha", "Cantidad"};
        return columna;
    }
    
    public void setFilas(){
        try {
            ResultSet rst = abd.llenarTablaProvee();
            Object datos[] = new Object[5];
            while(rst.next()){
                for(int i=0;i<5;i++){
                    datos[i]=rst.getObject(i+1);
                }
                tablaProvee.addRow(datos);
            }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 90, 140, -1));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 110, 170, 20));
        ...
        jPanel1.add(jt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 50, 140, -1));
        jPanel1.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 70, 170, 20));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 50, 320, 140));

        jLabel14.setBackground(new java.awt.Color(0, 102, 102));
        jLabel14.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(0, 102, 102));
        jLabel14.setText("Cantidad:");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, -1, -1));

        jLabel15.setBackground(new java.awt.Color(0, 102, 102));
        jLabel15.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(0, 102, 102));
        jLabel15.setText("Fecha:");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 130, -1, -1));

        jt4.setForeground(new java.awt.Color(102, 102, 102));
        jt4.setText("Cantidad....");
        jt4.setBorder(null);
        ...
        jPanel1.add(jt4, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 170, 140, -1));
        jPanel1.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 150, 170, 20));
        jPanel1.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 190, 170, 20));
        ...
        jPanel1.add(jt3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, 140, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, abd.agregarProveer(Integer.parseInt(jt2.getText()), Integer.parseInt(jt1.getText()), jt3.getText(), Integer.parseInt(jt4.getText())));
        jt1.setText("");
        jt2.setText("");
        jt3.setText("");
        jt4.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(idA>0){
            JOptionPane.showMessageDialog(null, abd.eliminarRegistro(idA,"provee"));
        }else{
    ...
    private void jTable1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseEntered
        try {
            for (int i = 0; i < tablaProvee.getRowCount(); i++) {
                tablaProvee.removeRow(i);
                i-=1;
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
