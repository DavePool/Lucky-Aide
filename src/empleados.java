...
public class empleados extends javax.swing.JFrame {
    ...
    public empleados() {
        tablaEmpleados= new DefaultTableModel(null, getColumnas());
        initComponents();
        this.setLocationRelativeTo(null);
         // setIconImage(new ImageIcon(getClass().getResource("../Images/WV_Mesa de trabajo 1.png")).getImage());
    }
    
    public String[] getColumnas(){
        String columna[] = new String[]{"Id", "Nombre", "Fecha de contrato", "Fecha de nacimiento","Escolaridad"};
        return columna;
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(tablaEmpleados);
...
if (result == 0)
{
    ...
    RG_registrar_empleado log = new RG_registrar_empleado();
      log.setVisible(true);
 ...
 RG_editar_empleado log = new RG_editar_empleado();
      log.setVisible(true);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      RG_borrar_Empleado log = new RG_borrar_Empleado();
      log.setVisible(true);
