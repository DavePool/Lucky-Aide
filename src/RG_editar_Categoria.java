...
public class RG_editar_Categoria extends javax.swing.JFrame {
    conexionBD abd = new conexionBD();
    public RG_editar_Categoria() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Editar Categoria");
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 220, 120, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, abd.cambiarCategoria(jt2.getText(), jt3.getText(), Integer.parseInt(jt1.getText())));
        jt1.setText("");
        jt2.setText("");
        jt3.setText("");
