...
public class producto extends javax.swing.JFrame {
    ...
    public producto() {
        tablaProductos= new DefaultTableModel(null, getColumnas());
        initComponents();
    ...
    public String[] getColumnas(){
        String columna[] = new String[]{"Id", "Nombre", "Precio", "Existencias"};
        return columna;
    }
    
    public void setFilas(){
        try {
            ResultSet rst = abd.llenarTabla("producto");
...
if (result == 0)
{
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        RG_registrar_producto log = new RG_registrar_producto();
      log.setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        RG_editar_producto log = new RG_editar_producto();
      log.setVisible(true);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     RG_borrar_producto log = new RG_borrar_producto();
      log.setVisible(true);
