...
public class RG_registrar_Categoria extends javax.swing.JFrame {
    conexionBD abd = new conexionBD();
    public RG_registrar_Categoria() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Registrar Categoria");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, abd.agregarCategoria(jt2.getText(), jt3.getText()));
        jt2.setText("");
        jt3.setText("");
