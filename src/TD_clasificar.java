...
public class TD_clasificar extends javax.swing.JFrame {
    conexionBD abd = new conexionBD();
    DefaultTableModel tablaClasifica;
    int idA;
    
    public TD_clasificar() {
        tablaClasifica= new DefaultTableModel(null, getColumnas());
        initComponents();
        this.setLocationRelativeTo(null);        
    }
    
    public String[] getColumnas(){
        String columna[] = new String[]{"Id", "Categoria","Producto"};
        return columna;
    }
    
    public void setFilas(){
        try {
            ResultSet rst = abd.llenarTablaClasifica();
            Object datos[] = new Object[3];
            while(rst.next()){
                for(int i=0;i<3;i++){
                    datos[i]=rst.getObject(i+1);
                }
                tablaClasifica.addRow(datos);
            }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 140, -1));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 170, 170, 20));
        ...
        jPanel1.add(jt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 110, 140, -1));
        jPanel1.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, 170, 20));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 200, 120, 40));

        jTable1.setModel(tablaClasifica);
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 50, 390, 130));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 720, 260));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, abd.agregarClasifica(Integer.parseInt(jt2.getText()), Integer.parseInt(jt1.getText())));
        jt1.setText("");
        jt2.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(idA>0){
            JOptionPane.showMessageDialog(null, abd.eliminarRegistro(idA,"clasifica"));
        }else{
    ...
    private void jTable1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseEntered
        try {
            for (int i = 0; i < tablaClasifica.getRowCount(); i++) {
                tablaClasifica.removeRow(i);
                i-=1;
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
