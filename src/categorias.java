...
public class categorias extends javax.swing.JFrame {
    ...
    public categorias() {
        tablaCategorias= new DefaultTableModel(null, getColumnas());
        initComponents();
        this.setLocationRelativeTo(null);   
    }
    
    public String[] getColumnas(){
        String columna[] = new String[]{"Id", "Nombre", "Descripcion"};
        return columna;
    }
    
    public void setFilas(){
        try {
            ResultSet rst = abd.llenarTabla("categoria");
            Object datos[] = new Object[3];
            while(rst.next()){
                for(int i=0;i<3;i++){
                    datos[i]=rst.getObject(i+1);
                }
                tablaCategorias.addRow(datos);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(tablaCategorias);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     RG_registrar_Categoria log = new RG_registrar_Categoria();
      log.setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
         RG_editar_Categoria log = new RG_editar_Categoria();
      log.setVisible(true);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        RG_borrar_categoria log = new RG_borrar_categoria();
      log.setVisible(true);
